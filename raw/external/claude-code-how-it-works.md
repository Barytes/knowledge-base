...
![Session continuity: resume continues the same session, fork creates a new branch with a new ID.](https://mintcdn.com/claude-code/c5r9_6tjPMzFdDDT/images/session-continuity.svg?w=2500&fit=max&auto=format&n=c5r9_6tjPMzFdDDT&q=85&s=d83b5f81e9d6d42d2bff0daa44d6a3ec)
...
## [Extend with features](https://code.claude.com/docs/en/features-overview)
