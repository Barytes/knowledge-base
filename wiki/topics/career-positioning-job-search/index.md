...
- [fake work：从内部记分牌到真实结果](fake-work-从内部记分牌到真实结果.md): fake work 不是按报告、会议、代码或岗位形式给工作贴标签，而是检查一项可见动作能否继续追到真实变化。当组织用“我正在推进”的证据代替难以测量的价值，AI 会先降低生产这种证据的成本，也可能把缓慢浪费放大成高速浪费。
- [三年 500 万目标下的职业与生活资源配置](三年500万目标下的职业与生活资源配置.md): > **状态更新（2026-07-30）：** 用户已被朋友的深圳创业公司裁员，原有每月 2 万元现金流结束。本文“当前处境”与“未来 90 天”中围绕该工作的判断是 2026-07-17 的历史快照，不应继续作为当前现金流前提。最新执行判断见 当前项目收束（2026-07-30）。
...
- [真本事：从会工作到会赚钱](真本事-从会工作到会赚钱.md): 《真本事》讨论的是：离开学校和组织的内部记分牌以后，怎样获得、打造和放大个人价值，并逐步获得赚钱与自由的能力。本页按来源版本保留作者原本的强表述；2026-08-29 开放 V1 中新增的适用边界单独列出，不用本库的温和措辞替换原书命题。
...
- [产品判断力与能力焦虑的分离观察](../../self/产品判断力与能力焦虑分离观察.md)
- [投简历恐惧观察](../../self/投简历恐惧观察.md)
- [Go to Market 策略：找到高价值工作](../../self/go-to-market-strategy.md)
