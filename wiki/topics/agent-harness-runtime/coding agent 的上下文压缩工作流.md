...
- [AI 时代的结果确定性：Agentic Runtime 与 Evaluation-First](AI%20时代的结果确定性%20Agentic%20Runtime%20与%20Evaluation-First.md)：那页强调 runtime 与 contract；本文更强调 runtime 内部的上下文预算管理与团队协作机制。
